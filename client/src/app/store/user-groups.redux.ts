...
export const currentUserReducer: Reducer<User> = (state: User = initialAppState.__currentUser, action: ActionWithValue<User>): User => {
    switch (action.type) {
...
export class MyAccountStateWrapperService {
    ...
    private currentUserQuery: Observable<User>;
